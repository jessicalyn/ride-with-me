...
export const fetchRideInfo = () => {
  return async (dispatch) => {
    ...
    try {
      ...
      const searchParams = '{ availableRides{id status availableSeats departureDate price description mileage travelTime driver{id uuid firstName}ridepassengerSet{passenger{id firstName imageUrl}}endCity{id name}startCity{id name}} }'
